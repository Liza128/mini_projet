...
require_once("connexion.php");
 ...
 $requete="select * from voiture where imt_vtr= '$imt'";
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title  text-center">
                        <h2 style="color:#ffd000; text-shadow: 2px 2px #FF0000;">réserver maintenant!</h2>
    ...
    <section id="lgoin-page-wrap" class="section-padding">
        <div class="container">
            <div class="row">
                ...
                <form id="login-form" class="form" action="reserver_form_v.php" method="GET" style="width: 90%;" onsubmit="return verifReservation(this)">
                ...
                <div style=" background-color: #fd6522; color: #fff; border-radius: 15px;">
                    ...
                    <div style="margin-bottom: 20px; padding: 40px;">
                        ...
                        <div class="champs">
                            ...
                            <input type="text" name="" id="" class="form-control" required value="<?php echo $voiture['mrq_vtr'];  ?>&nbsp; <?php echo $voiture['modele_vtr'];  ?>"
                                    style="border-radius: 40px; height: 60px;">




                                    <input type="hidden" name="imt"  value="<?php echo $_GET["immtV"]; ?>"
                                    >
         ...
         echo date('Y-m-d',strtotime('+1 days'));?> max= <?php  echo date('Y-m-d',strtotime('+120 days'));?>>
                        ...
                        <p class="champs">
                            <label for="dureeR">
                                <span class="form-label"style="font-weight:bold;font-size:20px;padding-top:15px;padding-left:10px"> duree de reservation (En jours )</span></label><br />
                                <input type="number" min="1" max="31" step="1" style="border-radius: 40px; height: 60px; "
                                class="form-control" name="duree_res" id="dureeR"  required placeholder="Le nombre de jours ">
