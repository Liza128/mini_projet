            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title  text-center">
                        <h2 style="color:#ffd000; text-shadow: 2px 2px #FF0000;">espace client</h2>
                    ...
                    <div class="col-md-4 ">
                        ...
                        <div class="col-md-12 " style="background-color:#EAEAEA;height:400px ;padding-top:10px">
                            ...
                            <div class="  col-md-12  " style="color:black; padding-top:30px">
                                ...
                                <a href="reserver_p.php" style="color:black;font-weight:bold; font-size:20px"><img
                                        src="assets/img/res5.png" width="25px"> Réserver une voiture</a>
                                </br>
                                </br>
                                <!-- <a href="voitures_dispo.php" style="color:black;font-weight:bold; font-size:20px"><img -->
                                        <!-- src="assets/img/scroll-top.png" width="20px"> voitures disponibles</a> -->
                                <!-- </br> -->
                                <!-- </br> -->
                                ...
                                <a href="conditions2.php" style="color:black;font-weight:bold; font-size:20px"><img
                                        src="assets/img/2.png" width="30px"> conditions de location</a>
