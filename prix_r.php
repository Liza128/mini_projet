...
<li><a href="deconnexion.php">   déconnexion</a> </li>
    ...
    <div id="navbar" class="   col-md-12 " style="" align="center">
        ...
        <li>  <a style="color:white"
                                            href="prix.php?prix=<?php echo '3000';   ?>"><= 3000 DA</a></li>
                                            <li> <a style="color:white" href="prix.php?prix=<?php echo '4000';   ?>"><= 4000 DA</a></li>
                                            <li> <a style="color:white"
                                            href="prix.php?prix=<?php echo '5000';   ?>"><= 5000 DA</a></li>
                                            <li>  <a style="color:white"
                                            href="prix.php?prix=<?php echo '6000';   ?>"><= 6000 DA</a></li>
                                            <li><a style="color:white"
                                            href="prix.php?prix=<?php echo '7000';   ?>"><= 7000 DA</a></li>
