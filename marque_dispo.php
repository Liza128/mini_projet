<?php
     ...
     $sql =  "SELECT * FROM voiture where mrq_vtr='$marque'" ;
...
<ul>
<li class="active"><a href="espace_client.php">Accueil</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title  text-center">
                        <h2 style="color:#ffd000; text-shadow: 2px 2px #FF0000;">voitures disponibles</h2>
                                ...
                                <div class="single-popular-car">
                                   ...
                                   mdl=<?php echo $donnees['modele_vtr']; ?>&
                                    ...
                                    "> 
                                     ...
                                     <img src="assets/img/voitures/<?php echo $donnees['photo'] ; ?>" class="card-img-top"
                                            alt="Accroche HTML" alt="voiture" height="100px" width="170px"
