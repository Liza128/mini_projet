...
<body class="loader-active">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title  text-center">
                        <h2 style="color:#ffd000; text-shadow: 2px 2px #FF0000;">nos voitures</h2>
    ...
    <div id="navbar" class="   col-md-12 " style="" align="center">

        <ul>
        
        <li>    <a style="color:white" href="marque_dispo.php?marque=<?php echo 'renault';   ?>">renault&nbsp;&nbsp;<img
                    src="assets/img/renault.png" width="30px"></a></li>
                    <li>   <a style="color:white"
                href="marque_dispo.php?marque=<?php echo 'volkswagen';   ?>">volkswagen&nbsp;&nbsp;<img
                    src="assets/img/volkswagen1.png" width="30px"></a></li>
                    <li>    <a style="color:white" href="marque_dispo.php?marque=<?php echo 'peugeot';   ?>">peugeot&nbsp;&nbsp;<img
                    src="assets/img/peugeot.png" width="30px"></a></li>
                    <li>    <a style="color:white" href="marque_dispo.php?marque=<?php echo 'mercedes';   ?>">mercedes&nbsp;&nbsp;<img
                    src="assets/img/mercedes.png" width="30px"></a></li>
