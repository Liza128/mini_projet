 ...
 require_once("connexion.php");
  ...
  // si on a reçu une valeur du formulaire
    $date = $_GET['date_debut_res'];
	 $imt_vtr = $_GET['voiturechoisie'];
     $duree_res=$_GET['duree_res'];
      $id=$_SESSION['id_clt'];
    
     $sql = "INSERT INTO `reservation`(`date_debut_res`, `imt_vtr`, `duree_res` ,`id_clt` ,`etat_res`) 
     VALUES (?,?,?,?,?)";
...
$exec= $resultat->execute($params);
      ...
      /* else{
            echo'<script>alert("veuillez saisir toutes les données");</script>';
            }*/
