                            ...
                            <form action="inscrirVisiteur.php" method="POST">
                                <div class="name">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label" for="dateD"
                                                style="font-weight:bold;font-size:15px;padding-top:1px;margin-right:120px">Prénom:</label>
                                ...
                                <div class="name">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                        <label class="form-label" for="dateD"
                                                style="font-weight:bold;font-size:15px;padding-top:1px;margin-right:120px">Téléphone:</label>
                                ...
                                <label class="form-label" for="dateD"
                                    ...
                                    <input type="password" name="mdp"  required placeholder="mot de passe" id="mdp" pattern=".{8,}"  title="8 caractéres le minimum">   
                                  <p id="message"></p>
                                ...
                                <label class="form-label" for="dateD"
                                    ...
                                    <input type="password" name="password_clt" id="confirmPwd"   required placeholder="confirmer le mot de passe" style="color:black"  pattern=".{8,}"  title="8 caractéres le minimum">
