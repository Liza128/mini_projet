...
<li><a href="deconnexion.php">   déconnexion</a> </li>
    ...
    <div id="navbar" class="   col-md-12 " style="background-color:blue;" align="center">

        <ul>
        <li>  <a style="color:white" href="classe.php?classe=<?php echo 'cabriolet';   ?>">cabriolet</a></li>
        <li>   <a style="color:white" href="classe.php?classe=<?php echo '4x4';   ?>">4x4</a></li>
        <li>   <a style="color:white" href="classe.php?classe=<?php echo 'citadine';   ?>">citadine</a></li>
        <li>    <a style="color:white" href="classe.php?classe=<?php echo 'monospace';   ?>">monospace</a></li>
        <li>   <a style="color:white" href="classe.php?classe=<?php echo 'break';   ?>">break</a></li>
        <li>   <a style="color:white" href="classe.php?classe=<?php echo 'compacte';   ?>">compacte</a></li></li>
